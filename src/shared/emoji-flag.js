...
export const countries = {
  ...
  BZ: ['Belize', 'Belizean'],
  CA: ['Canada', 'Canadian'],
  CC: ['Cocos (Keeling) Islands', 'Cocos [Keeling] Islands', 'Cocos Islander'],
  CD: [
  ...
  KR: ['Korea, Republic of', 'Korea', 'South Korea', 'South Korean'],
  KW: ['Kuwait', 'Kuwaiti'],
  ...
  ML: ['Mali', 'Malian'],
  MM: ['Myanmar', 'Burma', 'Burmese', 'Myanmar [Burma]'],
  ...
  TV: ['Tuvalu', 'Tuvaluan'],
  TW: ['Taiwan', 'Taiwanese'],
  TZ: ['Tanzania, United Republic of', 'Tanzania', 'Tanzanian'],
  ...
  VI: ['Virgin Islands, U.S.', 'U.S. Virgin Islands'],
...
function nameToCode(country = '') {
  let found = '';
  if (!country || !country.trim()) return found;
  Object.keys(countries).forEach((code) => {
    if (found) return;
    countries[code].forEach((name) => {
...
function countryToFlag(country = '') {
  if (country.toLowerCase() === 'earth') {
    return '🌏';
  }
  const isCode = !!countries[country.toUpperCase()];
  const code = isCode ? country : nameToCode(country);
  if (!code) {
    return '';
  }
  if (code && String && String.fromCodePoint) {
